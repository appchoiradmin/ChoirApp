...
namespace ChoirApp.Infrastructure.Migrations
{
    ...
    [Migration("20250712205701_RemoveLegacyChoirSongEntities")]
    partial class RemoveLegacyChoirSongEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.SongVersion", b =>
                {
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.VersionTag", b =>
                {
                    b.Property<Guid>("VersionId")
                        .HasColumnType("uuid")
                        .HasColumnName("version_id");
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.VersionVisibility", b =>
                {
                    b.Property<Guid>("VersionId")
                        .HasColumnType("uuid")
                        .HasColumnName("version_id");
                    ...
                    b.HasKey("VersionId", "ChoirId");

                    b.HasIndex("ChoirId");

                    b.HasIndex("ChoirId1");

                    b.ToTable("VersionVisibilities");
                });
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.PlaylistSong", b =>
                {
                    ...
                    b.HasOne("ChoirApp.Domain.Entities.SongVersion", "SongVersion")
                        .WithMany()
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.SongVersion", b =>
                {
                    ...
                    b.HasOne("ChoirApp.Domain.Entities.SongVersion", "ParentVersion")
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.VersionTag", b =>
                {
                    ...
                    b.HasOne("ChoirApp.Domain.Entities.Tag", null)
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.VersionVisibility", b =>
                {
                    ...
                    b.HasOne("ChoirApp.Domain.Entities.Choir", null)
                        .WithMany("VersionVisibilities")
                        .HasForeignKey("ChoirId1");
            ...
            modelBuilder.Entity("ChoirApp.Domain.Entities.Choir", b =>
                {
                    ...
                    b.Navigation("VersionVisibilities");
                });
